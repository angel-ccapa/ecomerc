                ...
                <div className="login_Form bg-red-50 px-8 py-6 border border-red-100 rounded-xl shadow-md">
                    ...
                    <div className="mb-3">
                        <textarea
                            ...
                            name="description"
                            placeholder="Descipcion del producto"
                            rows="5"
                            className=" w-full px-2 py-1 text-red-300 bg-red-50 border border-red-200 rounded-md outline-none placeholder-red-300 "
                        ></textarea>
                    </div>
